...
module.exports = {  // cached singleton instance
    ...
    async tryConnection() {
        const handleConnectivityChange = await NetInfo.fetch();
        return this.handleConnectivityChange(handleConnectivityChange);
    },
    ...
    async defaultVerifyServersAreUp() {
        try {
            ...
            return (googleResult.status >= 200 && googleResult.status < 400);
        } catch (e) {
            if (e
                && e.message
                && e.message.indexOf
